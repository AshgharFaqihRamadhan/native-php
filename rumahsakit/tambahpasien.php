            ...
            <div class="col-4">
                ...
                <form action="koneksi.php" method="POST">
                    <div class="form-group">
                        <label for="idPasien">Nik</label>
                        <input type="text" class="form-control mb-3" name="idPasien" placeholder="idPasien">
                    </div>
                    <div class="form-group">
                        <label for="nmPasien">Nama </label>
                        <input type="text" class="form-control mb-3" name="nmPasien" placeholder="nmPasien ">
                    </div>
                    <div class="form-group">
